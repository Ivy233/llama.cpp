...
./build/bin/llama-embedding -m /root/autodl-tmp/Model/BGE-VL-large-GGUF/BGE-VL-large-vision-F16.gguf --n-gpu-layers 0 --image /root/BGE-VL-result/sample.png -c 257
