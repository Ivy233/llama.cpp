...
class BGEClipConverter:
    ...
    def set_gguf_parameters(self):
        ...
        self.text_gguf_writer.add_embedding_length(self.projection_dim)
        ...
        self.vision_gguf_writer.add_embedding_length(self.projection_dim)
        ...
        self.vision_gguf_writer.add_uint32(f"{CLIP_VISION_ARCH}.hidden_size", self.vision_hidden_size)
